...
<body id="login">
	...
	<form method="post" class="formulario" action="jsp/verifica_login.jsp">
		...
		<a href="jsp/cadastro.jsp"><input type="button" name="cadastrar" value="cadastro" class = "btn btn-primário"></a>
	</form>
	</div>
</body>
</html>